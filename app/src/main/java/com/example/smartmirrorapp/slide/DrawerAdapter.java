...
public class DrawerAdapter extends RecyclerView.Adapter<DrawerAdapter.ViewHolder> {
    private List<DrawerItem> items;//private List<DrawerItem<ViewHolder>> items;
    private Map<Class<? extends DrawerItem>, Integer> viewTypes;
    private SparseArray<DrawerItem<ViewHolder>> holderFactories;
    private OnItemSelectedListener listener;
    public DrawerAdapter(List<DrawerItem> items){// public DrawerAdapter(List<DrawerItem<ViewHolder>> items){
        this.items = items;
    ...
    private void processViewTypes() {
        int type = 0;
        for (DrawerItem<ViewHolder> item : items){
